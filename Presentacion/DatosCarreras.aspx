<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DatosCarreras.aspx.cs" Inherits="Presentacion.DatosCarreras" %>
        ...
        <div>
            ...
            <asp:Panel runat="server">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <asp:Repeater ID="repeaterCarreras" runat="server" OnItemCommand="repeaterCarreras_ItemCommand">
                            <ItemTemplate>
                                <tr>
                                    <td><%# string.Format("{0}", Eval("IdCarrera")) %></td>
                                    <td><%# string.Format("{0}", Eval("NombreCarrera")) %></td>
                                    <td> <a href='<%# string.Format("https://localhost:44377/DatosMaterias.aspx?IdCarrera={0}", Eval("IdCarrera"))%>'>Ver más</a></td>
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>
                    </tbody>
